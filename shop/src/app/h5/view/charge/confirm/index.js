...
import Updata from '../address/updata';
...
export default class extends Component {
    ...
    submit = () => {
        ...
        if(window.bridgeData.shopcoin < total) {
            Toast.info('余额不足', 1);
            return false;
        }
        if(addressList.length <= 0) {
    ...
    render() {
        ...
        return (
            <div className='confirm'>
                {addressList.length > 0&&<div className='address' onClick={() => {
